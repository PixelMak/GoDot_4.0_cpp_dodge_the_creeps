...
void initializer(godot::ModuleInitializationLevel p_level)
{
  ...
  if (p_level == godot::MODULE_INITIALIZATION_LEVEL_SCENE)
  {
    ...
    godot::ClassDB::register_class<game_lib::TestNode2D>();
    godot::ClassDB::register_class<game_lib::Player>();
    godot::ClassDB::register_class<game_lib::Mob>();
    godot::ClassDB::register_class<game_lib::Main>();
    godot::ClassDB::register_class<game_lib::HUD>();
  }
}
...
extern "C"
{
  ...
  GDExtensionBool GDE_EXPORT game_lib_library_init(const GDExtensionInterface *p_interface, const GDExtensionClassLibraryPtr p_library, GDExtensionInitialization *r_initialization)
  {
